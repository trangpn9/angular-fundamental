...
export class EventService {
  ...
  getEvents(): Observable<IEvent[]> {
    ...
    // Get data by face server at local
    return this.http.get<IEvent[]>('/api/events')
      .pipe(catchError(this.handleError<IEvent[]>('getEvents', [])));
  }

  getEventById(id: number):Observable<IEvent> | undefined {
  ...
  searchSessions(searchTerm: string): Observable<ISession[]> {
    ...
    //   let matchingSessions = event.sessions.filter(sesion => sesion.name.toLocaleLowerCase().indexOf(term) > -1);
...
const EVENTS:IEvent[] = [
  {
    ...
    time: '10:00 am',
    price: 599.99,
    imageUrl: '/assets/images/atm-01.jpeg',
    location: {
      address: '1057 DT',
      city: 'London',
      country: 'England'
  ...
  },
  {
    ...
    time: '9:00 am',
    price: 950.00,
    imageUrl: '/assets/images/atm-02.jpeg',
  ...
  },
  {
    ...
    time: '9:00 am',
    price: 759.00,
    imageUrl: '/assets/images/atm-03.jpeg',
    location: {
  ...
  },
  {
    ...
    time: '8:00 am',
    price: 800.00,
    imageUrl: '/assets/images/techcombank.jpeg',
    location: {
